...
const Achive = () => {
  return (
    <>
      <div className="achive" id='achivements'>
        ...
        <div className="title">
        <span><h2>Compititive Programming : </h2></span>
        </div>
        <div className="content">
        300+ Questions solved on different coding plateforms like Leetcode, GFG, and Coding Ningas. 1450+ raking on
Leetcode in compititive coding.
        </div>
